...
namespace NSBManager.ManagementService.UnitTests.EndpointControl
{
    ...
    public class when_a_endpoint_is_started
    {
        ...
        private It should_result_in_a_notification_to_the_clients = () =>
                                                                    bus.AssertWasPublished<EndpointStartedEvent>(
                                                                        e => e.Endpoint.Id == startedEndpoint.Id);
        private It should_have_status_set_to_running = () =>
                                                     SUT.GetSnapshot().First().Status.ShouldEqual(EndpointStatus.Running);


        private static IBus bus;
        private static IBusTopology SUT;
